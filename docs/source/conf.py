...
htmlhelp_basename = 'FriendlyBotdoc'
...
latex_documents = [
    (master_doc, 'FriendlyBot.tex', u'FriendlyBot Documentation',
     u'FriendlyBot Staff', 'manual'),
]
...
man_pages = [
    (master_doc, 'friendlybot', u'FriendlyBot Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'FriendlyBot', u'FriendlyBot Documentation',
     author, 'FriendlyBot', 'One line description of project.',
     'Miscellaneous'),
]
